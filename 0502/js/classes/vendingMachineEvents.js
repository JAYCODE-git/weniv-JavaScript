class VendingMachineEvents {
    ...
    bindEvent() {
        ...
        this.btnGet.addEventListener('click', () => {
            ...
            // dataset.price * strong 모두더하기 reduce
            this.getList.querySelectorAll('li').forEach((itemGet) => {
                //! itemStagedList.forEach((itemGet) => {
                // this.txtTotal.textContent = parseInt(this.txtTotal.textContent) +
                // (parseInt(itemGet.dataset.price) * parseInt(itemGet.querySelector('strong').firstChild.textContent))
