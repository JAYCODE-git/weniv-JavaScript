...
Because 'Not a Number' is not a number, and is not equal to anything,
including Not a Number.
*/
...
console.warn('isNaN이 undefined / null / NaN t/f 값을 반환할 때 왔다갔다하는 걸 볼 수있음.')
console.log(isNaN(undefined)); // true
console.log(isNaN(null)); // false
console.log(isNaN(NaN)); // true

// ES6에서 추가 도입(암기)
console.warn('Number.isNaN(요소) 방식으로 사용 권장')
