...
//     "https://raw.githubusercontent.com/nugurejeil/sharingPhoto/main/mazayoung.png",
...
// arrPic.forEach((i) => {
//     // const elLi = list.appendChild('li')
...
//     // item.style.transform = `rotateY(0) translateZ(var(${radius}px)`;
